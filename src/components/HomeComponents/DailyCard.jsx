...
export default function DailyCard() {
    return (
        <Link
            to="/daily"
            className="group relative w-full sm:w-[calc(50%-12px)] md:w-full bg-gradient-to-br from-[#0F172A]/80 to-[#020617]/90 backdrop-blur-xl border border-indigo-500/20 shadow-[0_8px_32px_rgba(0,0,0,0.3)] rounded-[24px] overflow-hidden flex items-center justify-between transition-all duration-300 hover:bg-slate-900/30 hover:-translate-y-2 hover:shadow-[0_15px_40px_rgba(99,102,241,0.2)] hover:border-indigo-500/50 p-6 min-h-[140px]"
        >
            ...
            <div className="z-10 bg-white/5 p-4 rounded-2xl border border-white/10 group-hover:bg-white/10 transition-colors group-hover:rotate-12 group-hover:scale-110 shadow-lg relative">
                ...
                <i className="fa-solid fa-calendar-day text-4xl text-indigo-400 group-hover:text-cyan-300 drop-shadow-[0_0_10px_rgba(99,102,241,0.5)]"></i>
            </div>
        </Link>
    );
}
